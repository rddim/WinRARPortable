...
user in an INI file next to WinRARPortable.exe called WinRARPortable.ini.
...
copy WinRARPortable.ini from this directory to WinRARPortable.ini next to
WinRARPortable.exe. The options in the INI file are as follows:
